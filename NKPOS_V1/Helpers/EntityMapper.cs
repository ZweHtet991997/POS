...
namespace NKPOS_V1.Helpers
{
    public static class EntityMapper
    {
        ...
        public static Sale ToEntity(this SaleModel model, Sale entity)
        {
            ...
            entity.CustomerName = string.IsNullOrEmpty(model.CustomerName) ? entity.CustomerName : model.CustomerName;
            entity.SaleMode = string.IsNullOrEmpty(model.SaleMode) ? entity.SaleMode : model.SaleMode;
            ...
            entity.DiscountType = string.IsNullOrEmpty(model.DiscountType) ? entity.DiscountType : model.DiscountType;
            entity.DiscountValue = model.DiscountValue ?? entity.DiscountValue;
            entity.DiscountAmount = model.DiscountAmount ?? entity.DiscountAmount;
            entity.TaxPercentage = model.TaxPercentage ?? entity.TaxPercentage;
            entity.TaxAmount = model.TaxAmount ?? entity.TaxAmount;
            entity.SubTotal = model.SubTotal ?? entity.SubTotal;
            entity.GrandTotal = model.GrandTotal ?? entity.GrandTotal;
            entity.InitialAmount = model.InitialAmount ?? entity.InitialAmount;
            entity.PaidAmount = model.PaidAmount ?? entity.PaidAmount;
            entity.ChangeAmount = model.ChangeAmount ?? entity.ChangeAmount;
